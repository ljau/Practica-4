      ...
      if(buscarFinTrama())
      {
               ...
               if (errores==0)
        {
           ...
           seteoSegundoNumero();
            ...
            if(numero1encontrado==1&&numero2encontrado==1 && errorEncontrado==0 && errorDivision0==0)
            {
               printf("\rel resultado es ");
               printf("%.4f\r\r/////////////////////////////////////\r", operation(numero1,numero2,operador));
            }
            else if (errorDivision0==1)
               printf("\rError, no se puede dividir entre 0!\r\r/////////////////////////////////////\r");               
...
void revisionDeErrores (void)
{
   ...
   {
      errorEncontrado=1;      
      if (errorExcedenteOperaciones==1)
      {
